...
@section('page-title', __('Edit Income'))
@section('content')
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">
                <i class="fas fa-edit text-warning me-2"></i>Edit Income
            </h1>
        </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body p-4">
            <form method="POST" action="{{ route('other-incomes.update', $income) }}" id="incomeForm">
                @csrf
                @method('PUT')
